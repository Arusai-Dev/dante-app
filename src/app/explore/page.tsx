        ...
        <>
            <div className="min-h-screen bg-neutral-900">
                            ...
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-gray-200">
                                        Discover and study community created
                                        sets
                                    </p>
                                </div>
                            </div>
                ...
                <div className="container mx-auto px-4 py-6">
                        ...
                        <TabsList className="grid w-full grid-cols-4 lg:grid-cols-7 h-auto bg-neutral-800">
                            {categories.map((category) => (
                                <TabsTrigger
                                    key={category}
                                    value={category}
                                    className="bg-neutral-800 text-white data-[state=active]:text-neutral-900 text-xs sm:text-sm"
                                >
                                    {category}
                                </TabsTrigger>
                            ))}
                    ...
                    (   
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                            {filteredSets.map((set) => (
                                <Link
                                    key={set.id}
                                    href={`/flashcards/preview/${set.id}`}
                                >
                                    <Card
                                        key={set.id}
                                        className="border-2 border-neutral-800 group hover:shadow-lg transition-all duration-200 cursor-pointer bg-[#D9D9D9]/3"
                                    >
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                <div className="flex items-center justify-between text-xs text-gray-50">
                                                    ...
                                                    <div className="flex items-center gap-1">
                                                        ...
                                                        <span>
                                                            {set.study_count.toLocaleString()}{" "}
                                                            studied
                                                        </span>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="flex flex-wrap gap-1">
                                                    {set.tags
                                                        ...
                                                        .map((tag) => (
                                                            <Badge
                                                                key={tag}
                                                                className="text-neutral-900 bg-white text-xs px-2 py-0"
                                                            >
                                                                {tag}
                                                            </Badge>
                                                        ))}
                                                ...
                                                <Button
                                                    onClick={() =>
                                                        redirect(
                                                            `/flashcards/practice/${set.id}`
                                                        )
                                                    }
                                                    className="w-full bg-white text-neutral-800 hover:bg-gray-200 cursor-pointer"
                                                    size="sm"
                                                >
                                                    Start Studying
                                                </Button>
                    ...
                    {filteredSets.length === 0 && Object.keys(flashcardSets).length !== 0 && (
